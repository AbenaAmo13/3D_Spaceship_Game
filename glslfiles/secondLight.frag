...
in vec3 planet_LightDir;  //light direction arriving from the vertex
...
void main(void)
{
	...
	color += material_specular * planetLight_specular * pow(RdotV, material_shininess);
